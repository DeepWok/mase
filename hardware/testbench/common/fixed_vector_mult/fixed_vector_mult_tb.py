...
class VerificationCase:
    def __init__(self, samples=10):
        ...
        self.ref = self.sweights_compute()
...
def runner():
    ...
    runner.build(
        ...
        toplevel="fixed_vector_mult",
        extra_args=extra_args,
    )

    runner.test(toplevel="fixed_vector_mult", py_module="fixed_vector_mult_tb")
