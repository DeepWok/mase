...
# Taken from https://github.com/spcl/QuaRot/blob/main/fake_quant/hadamard_utils.py
# Where they adpted from https://github.com/Cornell-RelaxML/quip-sharp/blob/main/lib/utils/matmul_had.py
...
# Random hadamard, without cuda accelerate 
