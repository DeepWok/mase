...
from .morr_linear_kernel import morr_linear_fn
...
class TritonMORRLinear(ONNBaseLayer):
    """
    ...
    def __init__(
        ...
        super(TritonMORRLinear, self).__init__()
    ...
    def forward(self, x: Tensor) -> Tensor:
        output, *_ = morr_linear_fn(
            ...
            phase_noise_std=(
                None if not self.enable_phase_noise else self.phase_noise_std
            ),
