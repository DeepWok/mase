...
quantized_basic_module_map = {
    ...
    "adaptive_avg_pool2d_fixed": AdaptiveAvgPool2dInteger,
    "avg_pool2d_fixed": AvgPool2dInteger,
    ...
    "batch_norm2d_fixed": BatchNorm2dInteger,
    "batch_norm2d_binary": BatchNorm2dBinary,
    "layer_norm_fixed": LayerNormInteger,
    "group_norm_fixed": GroupNormInteger,
    "instance_norm2d_fixed": InstanceNorm2dInteger,
    "rms_norm_fixed": RMSNormInteger,
...
quantized_bert_module_map = {
    "bert_self_attention_head_fixed": BertSelfAttentionHeadInteger,
    "bert_self_attention_fixed": BertSelfAttentionInteger,
    "grouped_query_attention_fixed": GroupedQueryAttentionInteger,
}
