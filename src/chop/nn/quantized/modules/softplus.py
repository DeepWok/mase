...
class _SoftplusBase(torch.nn.Softplus):
    ...
    def forward(self, x: Tensor) -> Tensor:
        if self.bypass:
            ...
            return F.softplus(x, self.inplace)
...
class SoftplusInteger(_SoftplusBase):
    bypass = None
...
class SoftplusMinifloatDenorm(_SoftplusBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftplusMinifloatIEEE(_SoftplusBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftplusLog(_SoftplusBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftplusBlockFP(_SoftplusBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftplusBlockMinifloat(_SoftplusBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftplusBlockLog(_SoftplusBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
...
class SoftplusBinary(_SoftplusBase):
    bypass = None
...
class SoftplusTernary(_SoftplusBase):
    bypass = None
