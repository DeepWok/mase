"""Qwen3 decoder layer with rounded vector residual boundaries."""
...
class Qwen3DecoderLayerMinifloat(Qwen3DecoderLayer):
    ...
    @classmethod
    def from_self(cls, layer: Qwen3DecoderLayer, q_config: dict = None):
        new_layer = cls(
