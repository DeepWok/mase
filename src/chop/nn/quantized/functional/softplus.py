...
def softplus_integer(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_binary(x, inplace=False, config=None):
...
def softplus_ternary(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_minifloat_denorm(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_minifloat_ieee(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_block_fp(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_block_minifloat(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
...
def softplus_block_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softplus(x, inplace=inplace)
    else:
