...
def gelu_integer(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_binary(x, inplace=False, config=None):
...
def gelu_ternary(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_minifloat_denorm(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_minifloat_ieee(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_block_fp(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_block_minifloat(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
...
def gelu_block_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.gelu(x, inplace=inplace)
    else:
