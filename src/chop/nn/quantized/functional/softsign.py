...
def softsign_integer(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_binary(x, inplace=False, config=None):
...
def softsign_ternary(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_minifloat_denorm(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_minifloat_ieee(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_block_fp(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_block_minifloat(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
...
def softsign_block_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.softsign(x, inplace=inplace)
    else:
