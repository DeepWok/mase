...
module {node_param_name}_source #(
    ...
    parameter OUT_DEPTH = {_cap(verilog_param_name)}_TENSOR_SIZE_DIM_0 * {_cap(verilog_param_name)}_TENSOR_SIZE_DIM_1 / ({_cap(verilog_param_name)}_PARALLELISM_DIM_0 * {_cap(verilog_param_name)}_PARALLELISM_DIM_1)
) (
    input clk,
    input rst,
