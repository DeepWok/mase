...
from torch.distributed.tensor.placement_types import _DTensorSpec as DTensorSpec
from torch.distributed.tensor.placement_types import _TensorMeta as TensorMeta
