...
class SoftermaxTB(Testbench):
    def __init__(self, dut) -> None:
        ...
        self.TOTAL_DIM = choice(range(self.PARALLELISM, self.TOTAL_MAX_DIM, self.PARALLELISM))

        self.dut.depth.value = self.TOTAL_DIM // self.PARALLELISM
...
def get_random_softermax_config():
    ...
    config = {
        "TOTAL_MAX_DIM": parallelism * depth,
