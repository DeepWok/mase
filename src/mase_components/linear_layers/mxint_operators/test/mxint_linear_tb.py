...
async def cocotb_test(dut):
    ...
    await tb.run_test(us=1000, num=5)
...
async def check_signal(dut):
    ...
    while True:
        ...
        await ReadOnly()
        print("fifo_data_out = ", dut.fifo_data_out_valid.value, dut.fifo_data_out_ready.value)
        # print("fifo_data_out = ", dut.fifo_data_out_ready.value)
        # if dut.data_out_0_valid.value == 1 and dut.data_out_0_ready.value == 1:
            # print("data_out_0 = ", [x.signed_integer for x in dut.mdata_out_0.value])
            # print("edata_out_0 = ", dut.edata_out_0.value.signed_integer)
        # if (
    ...
    mase_runner(
        ...
        module_param_list=[
            get_fixed_linear_config(
                {
                    "HAS_BIAS": 1,
                    "DATA_IN_0_TENSOR_SIZE_DIM_0": 192,
                    "DATA_IN_0_PARALLELISM_DIM_0": 32,
                    "DATA_IN_0_TENSOR_SIZE_DIM_1": 196,
                    "DATA_IN_0_PARALLELISM_DIM_1": 1,
                    "WEIGHT_TENSOR_SIZE_DIM_0": 192,
                    "WEIGHT_TENSOR_SIZE_DIM_1": 192,
                    "WEIGHT_PARALLELISM_DIM_0": 32,
                    "WEIGHT_PARALLELISM_DIM_1": 32,
                    "BIAS_TENSOR_SIZE_DIM_0": 192,
