...
def mxint_quant_block(
    x, width: int = 12, exponent_width: int = 6, exponent: int = None, round_bits: int = 0,
):
    """
...
def mxint_hardware(tensor, q_config, parallelism):
    ...
    qtensor = reshape_to_block(qtensor, t1, t0, p1, p0)
...
class MXIntLinearHardware(_LinearBase):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        self.config = {
            ...
            "round_bits": self.q_config["round_bits"],
        }
