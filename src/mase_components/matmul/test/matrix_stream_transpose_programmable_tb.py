...
class MatrixStreamTransposeTB(Testbench):
    def __init__(self, dut) -> None:
        ...
        self.assign_self_params(
            ["TOTAL_MAX_DIM0", "TOTAL_MAX_DIM1", "COMPUTE_DIM0", "COMPUTE_DIM1", "DATA_WIDTH"]
        )
        ...
        self.input_dim_0 = choice(range(self.COMPUTE_DIM0, self.TOTAL_MAX_DIM0+1, self.COMPUTE_DIM0))
        self.input_dim_1 = choice(range(self.COMPUTE_DIM1, self.TOTAL_MAX_DIM1+1, self.COMPUTE_DIM1))

        self.dut.in_depth_dim_0 = self.input_dim_0//self.COMPUTE_DIM0
        self.dut.in_depth_dim_1 = self.input_dim_1//self.COMPUTE_DIM1
    ...
    def model(self, X):
        ...
        X_matrix = rebuild_matrix(
            X, self.input_dim_0, self.input_dim_1, self.COMPUTE_DIM0, self.COMPUTE_DIM1
        )
        return split_matrix(
            X_matrix.T,
            self.input_dim_1,
...
def gen_random_params():
    ...
    return {
        "TOTAL_MAX_DIM0": compute_dim0 * randint(1, 3),
        "TOTAL_MAX_DIM1": compute_dim1 * randint(1, 3),
