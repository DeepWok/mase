...
def runner():
    ...
    verilog_sources = ["../../../../components/fixed_arith/fixed_adder_tree_layer.sv"]
    ...
    runner.build(
        ...
        hdl_toplevel="fixed_adder_tree_layer",
        build_args=extra_args,
    )

    runner.test(
        hdl_toplevel="fixed_adder_tree_layer", test_module="fixed_adder_tree_layer_tb"
    )
