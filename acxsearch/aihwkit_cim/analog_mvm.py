...
class ConfigError(Exception):
    """Simple exception for configuration errors.
    
    This is a simplified version of aihwkit's ConfigError used to indicate
    errors in configuration parameters or settings.
    """
    pass
