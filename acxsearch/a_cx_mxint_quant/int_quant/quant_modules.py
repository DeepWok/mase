...
class IntLayerNormImpl(nn.LayerNorm):
    """
    ...
    def __init__(self, 
        ...
        super(IntLayerNormImpl, self).__init__(normalized_shape, eps, elementwise_affine)
        self.dim_sqrt = None
...
class IntGELUImpl(nn.Module):
    ...
    def __init__(self, output_bit=8):
        super(IntGELUImpl, self).__init__()
...
class IntSoftmaxImpl(nn.Module):
    """
    ...
    def __init__(self, output_bit=8):
        super(IntSoftmaxImpl, self).__init__()
        self.output_bit = output_bit
