...
shell: build-docker
	docker run -it --shm-size 256m --hostname mase-ubuntu2204 -w /workspace -v /home/$(shell whoami):/root -v $(vhls):$(vhls) -v $(shell pwd):/workspace:z mase-ubuntu2204:latest /bin/bash 
