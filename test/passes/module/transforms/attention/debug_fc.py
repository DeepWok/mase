...
def debug_fc_replacement():
    ...
    max_length = 30
    with torch.no_grad():
        original_gen_ids = original_model.generate(input_ids, attention_mask=attention_mask, max_length=max_length)
        fc_gen_ids = fc_model.generate(input_ids, attention_mask=attention_mask, max_length=max_length)
