...
HD_PWD='/home/aw1223/new/mase/machop/mase_components/llmint/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LLMint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LLMint.tcl
