...
HD_PWD='/home/aw1223/new/mase/machop/mase_components/llmint/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LLMint.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LLMint.tcl -notrace
