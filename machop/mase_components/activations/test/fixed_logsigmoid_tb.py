...
async def test(dut):
    ...
    generate_memory.generate_mem("logsigmoid", in_data_width, in_frac_width, out_data_width, out_frac_width)
...
if __name__ == "__main__":
    ...
    generate_memory.generate_sv_lut("logsigmoid", dut_params["DATA_IN_0_PRECISION_0"], dut_params["DATA_IN_0_PRECISION_1"], dut_params["DATA_OUT_0_PRECISION_0"], dut_params["DATA_OUT_0_PRECISION_1"])
    print("Generated memory")    
    mase_runner(
        module_param_list=[
            dut_params
