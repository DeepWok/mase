...
from .utilities import StatisticsCollector, get_module_by_name
...
add_common_metadata_analysis_pass = dummy
init_metadata_analysis_pass = dummy
add_software_metadata_analysis_pass = dummy
