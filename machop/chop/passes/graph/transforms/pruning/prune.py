...
def prune_transform_pass(graph, save_dir=None, config=None):
...
def prune_unwrap_transform_pass(graph, *_):
...
# Iterators ----------------------------------------------------------------------------
def prune_graph_iterator(graph, save_dir: str, config: dict):
...
# Helper functions ---------------------------------------------------------------------
def _graph_iterator(graph, callback: callable):
...
def get_weight_prune_params(config: dict, graph):
...
def get_activation_prune_params(config: dict, graph):
