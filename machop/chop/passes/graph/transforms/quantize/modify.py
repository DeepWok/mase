...
def create_new_module(
    ...
    if mase_op == "linear":
        ...
        copy_weights(original_module.weight / original_module.running_var, new_module.weight)
        copy_weights(torch.zeros_like(original_module.running_var), new_module.running_var)
