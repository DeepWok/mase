...
def init_project(project_dir):
    ...
    Path(os.path.join(hardware_dir, "rtl")).mkdir(parents=True, exist_ok=True)
    Path(os.path.join(hardware_dir, "sim")).mkdir(parents=True, exist_ok=True)
    Path(os.path.join(hardware_dir, "test")).mkdir(parents=True, exist_ok=True)
    Path(os.path.join(hardware_dir, "hls")).mkdir(parents=True, exist_ok=True)
