...
@measure('tcet_syn_none', bn=True, mode='none', mt='synflow')  # change bn from Fasle to True, in order to avoid lnwot changes. We will manually remove bn in compute_tcet_score set synflow WITHOUT bn.
@measure('tcet_syn_log', bn=True, mode='log', mt='synflow')  # change bn from Fasle to True, in order to avoid lnwot changes. We will manually remove bn in compute_tcet_score set synflow WITHOUT bn.
@measure('tcet_syn_log1p', bn=True, mode='log1p', mt='synflow')  # change bn from Fasle to True, in order to avoid lnwot changes. We will manually remove bn in compute_tcet_score set synflow WITHOUT bn.
@measure('tcet_syn_norm', bn=True, mode='norm', mt='synflow')  # change bn from Fasle to True, in order to avoid lnwot changes. We will manually remove bn in compute_tcet_score set synflow WITHOUT bn.
...
@measure('t_cet', bn=True, mode='none', mt='synflow')  # change bn from Fasle to True, in order to avoid lnwot changes. We will manually remove bn in compute_tcet_score set synflow WITHOUT bn.
