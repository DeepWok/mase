...
def compute_naswot(net, inputs, targets, loss_fn, split_data=1, return_Kmats=False):
    ...
    net.K = 0.0  # **naswot matrix**, NONE-layer-wise | e (mat,) ===> using torch broadcasting tech to init zero-like matrix
    ...
    def counting_forward_hook(module, inp, out):
        ...
        K2 = (1.0 - x) @ (1.0 - x.t())
        net.K = (
            net.K + K.cpu().numpy() + K2.cpu().numpy()
        )  # remove this original code, since we want use broadcasting tech
        # except:
        #     pass
