...
class Cifar10Mase(datasets.CIFAR10):
    def __init__(
        self, root: os.PathLike, train: bool, transform: callable, download: bool, subset=False, subset_size_per_class=10
    ) -> None:
        self.subset = subset
...
def get_cifar_dataset(
    ...
    match name.lower():
        case "cifar10":
            dataset = Cifar10Mase(path, train=train, transform=transform, download=True, subset=subset)
        case "cifar100":
