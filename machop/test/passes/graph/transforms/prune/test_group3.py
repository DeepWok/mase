...
def run(config_file):
    ...
    '''
    model_short_name = config['model'];print("model used: ", model_short_name)
    dataset_short_name = config['dataset'];print("dataset used: ", dataset_short_name)
    ...
    weight_masks = None  # mask generated by weight pruning, will be assigned value later
    is_quantize = False
    '''
