...
#     # TODO: report node shape analysis is very broken..
#     mg, _ = report_node_shape_analysis_pass(mg, dummy_in)
#     mg, _ = report_node_type_analysis_pass(mg, dummy_in)
#     mg, _ = report_node_meta_param_analysis_pass(mg, dummy_in)
#     mg, _ = report_node_hardware_type_analysis_pass(mg, dummy_in)
#
#
# # --------------------------------------------------
# #   Execution
