...
model = get_yolo_segmentation_model(model_name)
...
TOML_PATH = f"{HERE}/yolov8nseg.toml"
...
mg.export("yolov8n_seg_int8_trt_calibrated")
...
mg.export("yolov8n_seg_int8_trt_QAT")
